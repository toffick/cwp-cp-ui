...
import MovieCreateFormContainer from "./containers/Views/MovieForm/MovieCreateFormContainer";
        ...
        return (
            <Layout>
                ...
                <Switch>
                    ...
                    <Route exact path="/admin-panel/create-movie" component={MovieCreateFormContainer}/>
                    <Route exact path="/error-page" component={NoMatch}/>
